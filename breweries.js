...
// 1) GET endpoint => /breweries ✔
// 3) GET endpoint => /breweries?brewery_type=TYPE
...
// 2) GET endpoint => /breweries/:id ✔

app.get("/breweries/:id", (req, res) => {
  const breweryId = Number(req.params.id);
  const brewery = breweriesDB.find(brewery => brewery.id === breweryId);
